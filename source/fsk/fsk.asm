...
kiss    set     0                                   ; give KISS data/debug data for SPY
...
agcN	equ	3*N				    ; agc analyse block lenght
agcGain equ	150.0				    ; agc integrator gain
...
; Symbol synchro
Ksym	equ	0.02				    ; symbol synchro pll loop gain

; DCD
DCDFil	equ	0.03				    ; decision error IIR LPF coefficient
DCDN	equ	@cvi(0.1*fd+.5) 		    ; delay (in s) after DCD off
...
; AGC control
	jset	#xmit,x:<flag,_agc		    ; if xmit on, do not update AGC
