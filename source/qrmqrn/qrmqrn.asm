...
;*	QEX, September 1992				       *
;*							       *
;* Copyright (C) 1993-1995 by Alef Null. All rights reserved.  *
;* Author(s): Jarkko Vuori, OH2LNS			       *
;* Modification(s):					       *
;*	improved parameters by Johan Forrer, KC7WW	       *
;***************************************************************


	nolist
	include 'leonid.asm'			    ; DSP CARD 4 monitor equates
	list

lmslen	equ	121        			    ; LMS filter lenght
...
beta	equ	0.0058				    ; 0.1875 adaptation coefficient
decay	equ	0.9800 	        		    ; coefficient decay value
	endif
